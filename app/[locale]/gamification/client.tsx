...
const GamificationClient = () => {
    ...
    const featureIcons = [
        <Sparkles key="i0" className="w-6 h-6 text-[#ffd03d]" />,
        <Users key="i1" className="w-6 h-6 text-[#ff8000]" />,
        <Trophy key="i2" className="w-6 h-6 text-[#ffd03d]" />,
        <Award key="i3" className="w-6 h-6 text-[#ff8000]" />,
        <ShoppingCart key="i4" className="w-6 h-6 text-[#ffd03d]" />,
        <Zap key="i5" className="w-6 h-6 text-[#ff8000]" />,
    ];
    const features = (
        t.raw("features") as { title: string; description: string }[]
