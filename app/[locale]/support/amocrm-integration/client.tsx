...
const STEPS: Step[] = [
    {
        n: 1,
        titleKey: "step1",
        image: "/images/integrations/amocrm/step-1.png",
        altKey: "step1",
    },
    {
        n: 2,
        titleKey: "step2",
        image: "/images/integrations/amocrm/step-2.png",
        altKey: "step2",
    },
    {
        n: 3,
        titleKey: "step3",
        image: "/images/integrations/amocrm/step-3.png",
        altKey: "step3",
    },
    {
        n: 4,
        titleKey: "step4",
        image: "/images/integrations/amocrm/step-4.png",
        altKey: "step4",
    },
];

export default function AmocrmIntegrationClient() {
    const t = useTranslations("amocrmIntegration");
        ...
        <main className="min-h-screen bg-[#fcfcfc] pt-[120px] pb-20">
            <section className="relative overflow-hidden">
                ...
                <div className="relative max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-20">
                    ...
                    >
                        <Image
                            src="/images/integrations/amocrm/hero.png"
                            alt={t("imageAlt.hero")}
                            width={1920}
                            height={980}
                            priority
